...
import { PROCESSING_ROUTING_KEY, NOTIFICATION_ROUTING_KEY, USER_ROUTING_KEY, BASE_URL } from "../config";
...
export default (app: Express, channel: Channel) => {
    app.post('/sprays', 
        ...
        asyncHandler(async (req: Request, res: Response) => {
            ...
            const {userId, caption, viewPermission, drawPermission, isLimited, deadline} = req.body
