...
class SprayRepository {
  ...
  async findSpraysByUserId(id: number, limit: number, offset: number) {
    const queryString = `SELECT *
                            FROM spray_schema.sprays
                            WHERE user_id = ${id}
  ...
  async findRespraysByOriginalId(id: number, limit: number, offset: number) {
    const queryString = `SELECT *
  ...
  async findRespraysByUserId(id: number, limit: number, offset: number) {
    const queryString = `SELECT *
                            FROM spray_schema.edits
  ...
  async getPublicSprays(limit: number, offset: number) {
    const queryString = `SELECT *
                            FROM spray_schema.sprays
  ...
  async editUrl(id: number, newUrl: string) {
  ...
  async editCaption(id: number, newCaption: string) {
    const queryString = `UPDATE spray_schema.sprays
  ...
  async editViewPermission(id: number, viewPermission: number) {
    const queryString = `UPDATE spray_schema.sprays
  ...
  async editDrawPermission(id: number, drawPermission: number) {
    const queryString = `UPDATE spray_schema.sprays
  ...
  async deleteSprayById(id: number) {
  ...
  async deleteSpraysByUserId(id: number) {
    const queryString = `DELETE FROM spray_schema.sprays
                            WHERE user_id = ${id}`;
