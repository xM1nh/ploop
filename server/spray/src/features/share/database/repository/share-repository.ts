...
class ShareRepository {
  async addShare(sprayId: number, userId: number) {
  ...
  async findShareByUserIdAndSprayId(sprayId: number, userId: number) {
  ...
  async deleteShareByUserIdAndSprayId(sprayId: number, userId: number) {
  ...
  async deleteSharesByUserId(id: number) {
    const queryString = `DELETE FROM spray_schema.shares
                            WHERE user_id = ${id}`;
  ...
  async deleteSharesBySprayId(id: number) {
    const queryString = `DELETE FROM spray_schema.shares
                            WHERE spray_id = ${id}`;
